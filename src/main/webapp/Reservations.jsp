...
<div style="margin-left: 10%; margin-right: 10%; margin-bottom: 10%; border: 2px solid grey; background-color: #fff;">
	...
	<form method="POST" action="LodgeServlet">
		...
		<tr><td colspan="2"><input type="text" name ="addressLine2" placeholder="Street Address Line 2" required></td></tr>
		...
		<tr><td><input type="text" name ="phoneNumber" required></td><td><input type="text" name ="userEmail" required></td></tr>
